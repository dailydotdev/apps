      ...
      {isOpen && pos && (
        <RootPortal>
          <div
            ...
            className="no-scrollbar z-popup flex w-64 flex-col gap-1 overflow-y-auto !rounded-10 border border-border-subtlest-tertiary !bg-accent-pepper-subtlest p-2 shadow-2"
          >
            {children}
          </div>
        </RootPortal>
