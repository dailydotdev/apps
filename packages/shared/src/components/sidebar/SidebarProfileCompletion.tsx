...
// Sidebar-native profile completion card. Lives at the top of the dedicated
// Profile panel and is intentionally flat (no fill) with a subtle border so
// it blends with the rest of the sidebar list. Mirrors the hover-revealed
// dismiss treatment used by the sidebar feedback button.
