...
export const plusFeatureList: Array<PlusItem> = [
  ...
  },
  {
    ...
    status: PlusItemStatus.Ready,
    tooltip: `Your AI agent does the reading for you: scans the latest dev landscape, filters the noise, and delivers only what matters.`,
    ...
    modalProps: {
      ...
      description:
        'Your AI agent does the reading for you: scans the latest dev landscape, filters the noise, and delivers only what matters.',
  ...
  },
  {
    ...
    status: PlusItemStatus.Ready,
    tooltip: `Turn any post into an interactive agent workflow. Ask AI to simplify concepts, challenge ideas, compare alternatives, or run your own custom prompts.`,
    icon: <CustomPromptIcon secondary />,
    iconClasses: 'bg-overlay-float-bacon text-accent-bacon-default',
    modalProps: {
      title: 'Run prompts on any post',
      description:
        'Turn any post into an interactive agent workflow. Ask AI to simplify concepts, challenge ideas, compare alternatives, or run your own custom prompts.',
