  ...
  return (
    <FlexCol
      className={classNames(
        'relative min-h-20 w-full items-center border-theme-divider-tertiary px-6 tablet:mb-6 tablet:border-b tablet:pb-20 laptopL:items-start laptopL:px-[4.5rem] laptopL:pb-14',
      )}
    >
      ...
      <SquadHeaderBar
        squad={squad}
        members={members}
        className="laptopL:absolute laptopL:right-[4.5rem] laptopL:top-0"
      />
      <EnableNotification
