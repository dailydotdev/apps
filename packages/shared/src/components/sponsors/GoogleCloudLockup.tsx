...
/**
 * Google Cloud's lockup, inline so it can be drawn two ways.
 *
 * The cloud keeps Google's four inks in both treatments' colour half;
 * the wordmark does not keep its shipped #5F6368, which is dark grey
 * and sinks into the dark feed. It rides `currentColor` instead, so it
 * reads grey on light and near-white on dark — what Google's own light
 * and dark lockups do, from one source rather than two files.
 *
 * As a silhouette the cloud drops its colours too and the whole mark
 * goes flat.
 *
 * Paths are Google's own artwork (viewBox 0 0 181 28); only the choice
 * of treatment is ours.
 */
export const GoogleCloudLockup = ({
  monochrome,
  ...
  >
    ...
    <path d="M140.45,22.15h-2.07V6h2.07Z" />
    <path d="M143.83,12.43a5.79,5.79,0,0,1,8.16,0,5.85,5.85,0,0,1,1.6,4.2,5.85,5.85,0,0,1-1.6,4.2,5.79,5.79,0,0,1-8.16,0,5.85,5.85,0,0,1-1.6-4.2A5.85,5.85,0,0,1,143.83,12.43Zm1.54,7.1a3.49,3.49,0,0,0,5.07,0,4,4,0,0,0,1.07-2.9,4,4,0,0,0-1.07-2.9,3.49,3.49,0,0,0-5.07,0,4,4,0,0,0-1.07,2.9A4,4,0,0,0,145.38,19.52Z" />
    <path d="M165.06,22.15h-2V20.62H163A3.85,3.85,0,0,1,161.54,22a4.08,4.08,0,0,1-2.05.55,3.89,3.89,0,0,1-3.14-1.26,5,5,0,0,1-1.07-3.38V11.11h2.07v6.42q0,3.09,2.73,3.09a2.54,2.54,0,0,0,2.1-1,3.77,3.77,0,0,0,.81-2.39V11.11h2.07Z" />
    <path d="M172.09,22.51a4.86,4.86,0,0,1-3.7-1.69,6,6,0,0,1-1.55-4.19,6,6,0,0,1,1.55-4.19,4.86,4.86,0,0,1,3.7-1.69,4.69,4.69,0,0,1,2.26.54,3.83,3.83,0,0,1,1.5,1.35h.09l-.09-1.53V6h2.07V22.15h-2V20.62h-.09a3.83,3.83,0,0,1-1.5,1.35A4.69,4.69,0,0,1,172.09,22.51Zm.34-1.89a3.3,3.3,0,0,0,2.49-1.08,4.05,4.05,0,0,0,1-2.91,4.05,4.05,0,0,0-1-2.91,3.38,3.38,0,0,0-5,0,4,4,0,0,0-1,2.9,4,4,0,0,0,1,2.9A3.3,3.3,0,0,0,172.43,20.62Z" />
  </svg>
);

export default GoogleCloudLockup;
