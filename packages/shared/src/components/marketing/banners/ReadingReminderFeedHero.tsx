...
type ReadingReminderFeedHeroProps = {
  className?: string;
  title?: string;
  subtitle?: string;
  onCtaClick?: () => void;
          ...
          <div className="flex flex-col tablet:flex-row tablet:items-stretch">
            <div className="flex flex-1 flex-col items-center p-5 text-center tablet:items-start tablet:p-6 tablet:text-left">
              <div className="flex flex-col items-center gap-1 tablet:items-start">
                <p className="text-white/80 mt-2 text-[0.875rem] tablet:text-[0.9375rem]">
                  {title}
                </p>
                <h3 className="font-bold text-white typo-title3 tablet:typo-title2">
                  {subtitle}
                </h3>
                <Button
                  type="button"
            ...
            <div className="bg-black/20 flex h-40 w-full items-center justify-center p-2 tablet:h-auto tablet:w-[14.5rem] tablet:p-3 laptopL:w-[16rem]">
              <ReadingReminderCatLaptop className="m-0 h-full w-full max-w-none object-contain tablet:scale-105 laptopL:scale-110" />
            </div>
          </div>
        </div>
      </div>
...
export default ReadingReminderFeedHero;
