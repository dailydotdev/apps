...
export const CardImage = classed(
  Image,
  'rounded-12 max-h-[12.5rem] object-cover w-full h-auto min-h-[10rem] mobileXL:aspect-auto mobileXL:max-h-40 mobileXL:w-40 mobileXXL:max-h-56 mobileXXL:w-56',
);
