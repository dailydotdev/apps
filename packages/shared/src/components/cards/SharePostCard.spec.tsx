...
it('should show author name and squad handle when enableSourceHeader is false', async () => {
  renderComponent({ enableSourceHeader: false });
  await screen.findByText('Lee Hansel Solevilla Jr');
  await screen.findByText('Avengers');
});

it('should show author name and author handle when enableSourceHeader is true', async () => {
