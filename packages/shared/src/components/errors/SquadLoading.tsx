...
function SquadLoading({
  ...
  return (
    <div className=" relative mb-4 flex max-w-full flex-1 flex-col items-start pb-16 pt-2 laptop:pt-8">
      ...
      />
      <FlexCol className="relative min-h-20 w-full items-center border-border-subtlest-tertiary px-6 tablet:mb-6 tablet:border-b laptop:pb-20 laptopL:items-start laptopL:px-18 laptopL:pb-14">
