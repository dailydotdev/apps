  ...
  return (
    <SearchPanelContext.Provider value={searchPanel}>
      ...
      >
        ...
        >
          {showDropdown && (
            <div className="absolute max-h-[30rem] w-full items-center overflow-y-auto rounded-b-16 border-0 border-border-subtlest-tertiary bg-background-default px-3 py-2 laptop:h-auto laptop:border-x laptop:border-b laptop:bg-background-subtle laptop:shadow-2">
