...
export interface PostDiscussionPanelProps {
   ...
   * when a parent (e.g. the redesign focus card) surfaces the strip elsewhere.
   */
  showMetaBar?: boolean;
  /**
   * Renders a small comment-sort toggle ("Newest first"/"Oldest first") at the
   * top of the comment list. Used by the redesign focus card, which moves the
 ...
 * EngagementRail and the post redesign focus card. Extracted so both surfaces
