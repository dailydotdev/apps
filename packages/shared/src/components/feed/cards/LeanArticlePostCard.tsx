...
import { PostCardHeader } from '../../cards/PostCardHeader';
import { PostCardFooter } from '../../cards/PostCardFooter';
...
export const LeanArticlePostCard = forwardRef(function PostCard(
  {
    post,
    onPostClick,
    onUpvoteClick,
