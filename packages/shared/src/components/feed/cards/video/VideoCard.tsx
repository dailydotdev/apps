...
import WatchTime from '../atoms/WatchTime';
import { CardVideoImage } from '../../../cards/Card';

export const VideoCard = ({ post }: CardType): ReactElement => {
  return (
    <CardContainer>
      <Card>
        ...
        <section className="flex flex-1">
          <div className="flex flex-col flex-1 mx-4">
            ...
            >
              ...
              <Separator />
              <WatchTime readTime={post.readTime} />
            </MetaContainer>
          </div>
        </section>
        <section>
