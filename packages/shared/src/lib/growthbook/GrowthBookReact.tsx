/* eslint-disable @typescript-eslint/no-explicit-any, @typescript-eslint/no-use-before-define, @typescript-eslint/explicit-module-boundary-types, consistent-return, react/destructuring-assignment, @typescript-eslint/no-shadow */
...
export function FeatureString(props: { default: string; feature: string }) {
  const { value } = useFeature(props.feature);
