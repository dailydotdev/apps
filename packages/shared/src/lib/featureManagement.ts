...
// Google Preferred Sources. One flag for every surface: the ask is the same ask
// everywhere and the cap is global, so splitting it per placement would let a
// reader meet it again after answering once.
