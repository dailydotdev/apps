...
export const followingFeedVersion = new Feature('following_feed_version', 15);
export const popularFeedVersion = new Feature('popular_feed_version', 15);
export const upvotedFeedVersion = new Feature('upvoted_feed_version', 15);
export const discussedFeedVersion = new Feature('discussed_feed_version', 15);
export const latestFeedVersion = new Feature('latest_feed_version', 15);
export const customFeedVersion = new Feature('custom_feed_version', 15);
