    ...
    >
      ...
      <style>
        {`
          ...
          @keyframes pulseGlow {
            0% { transform: scale(1); filter: drop-shadow(0 0 1px var(--accent-bacon-default)); }
            50% { transform: scale(1.15); filter: drop-shadow(0 0 5px var(--accent-bacon-default)); }
            100% { transform: scale(1); filter: drop-shadow(0 0 1px var(--accent-bacon-default)); }
          }
          @keyframes pulseText {
            0% { opacity: 0.7; }
            50% { opacity: 1; }
      ...
      <g className="notif-box">
        ...
        <rect
          ...
          strokeWidth="1"
        />
        {/* App Icon (glowing bacon) */}
        <circle
          cx="16"
          cy="16"
          r="6"
          className="notif-icon fill-accent-bacon-default"
        />
        {/* Title line (glowing white) */}
        <rect
          x="28"
          y="12"
          width="32"
