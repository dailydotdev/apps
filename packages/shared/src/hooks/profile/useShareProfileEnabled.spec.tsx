...
import { useShareProfileEnabled } from './useShareProfileEnabled';
...
describe('useShareProfileEnabled', () => {
  ...
  it('never evaluates anything when the caller opts out', () => {
    ...
    const { result } = renderHook(() => useShareProfileEnabled(false), {
      wrapper,
    });
