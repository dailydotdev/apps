...
export const QUESTIONS: PersonaQuestion[] = [
  ...
  { text: 'Your day is notebooks, datasets, and training runs.', layer: 1, lockPersonaId: 'ml-engineer' },
  ...
  { text: 'You build products on top of LLMs and AI agents.', layer: 2, lockPersonaId: 'ai-specialist' },
