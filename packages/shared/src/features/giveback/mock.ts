...
export const givebackCauses: GivebackCause[] = [
  {
    ...
    description:
      'The nonprofit backbone of free and open source software — legal support, fiscal sponsorship, and governance for the projects developers depend on.',
  ...
  },
  {
    ...
    description:
      'The nonprofit behind Python — maintaining the language, PyPI, python.org, and a global grants program that keeps Python alive.',
  ...
  },
  {
    ...
    name: 'NumFOCUS',
    description:
      'Keeps the open source scientific computing stack — NumPy, pandas, Jupyter, Matplotlib, and more — funded, governed, and growing.',
  ...
  },
  {
    ...
    description:
      'Makes software security visible and actionable through open source projects, the OWASP Top 10, and free security education for every developer.',
    url: 'https://owasp.org',
  ...
  },
  {
    ...
    name: 'freeCodeCamp',
    description:
      'Free, self-paced coding education at global scale — from HTML basics to data science and machine learning — for anyone with internet access.',
  ...
  },
  {
    ...
    name: 'CodePath',
    description:
      'Embeds industry-grade software engineering education directly into universities — free for students from underrepresented backgrounds.',
  ...
  },
  {
    ...
    description:
      'Global charity putting computing education in the hands of young people everywhere — through free curricula, Code Club, CoderDojo, and Raspberry Pi hardware.',
  ...
  },
  {
    ...
    name: 'CodeYourFuture',
    description:
      'Free coding school for refugees and people from disadvantaged backgrounds — with full support from learning through to employment in tech.',
  ...
  },
  {
    ...
    description:
      'Raises awareness and provides practical resources to support mental wellness in the tech and open source communities.',
  ...
  },
  {
    ...
    name: 'NV Access',
    description:
      'Builds and maintains NVDA, the free open source screen reader that gives blind and vision-impaired people full access to the digital world.',
  ...
  },
  {
    ...
    name: 'Human-I-T',
    description:
      'Turns donated tech into refurbished devices, low-cost internet, digital training, and e-waste diversion — making computing accessible and less wasteful.',
  ...
  },
  {
    ...
    description:
      'Rigorously researches and directs donations to the most cost-effective charities in the world — where each dollar saves the most lives.',
  ...
  {
    id: 'cause-hackyourfuture',
    name: 'HackYourFuture',
    description:
      'Free 9-month coding school in Amsterdam for refugees and people from disadvantaged backgrounds, with full career coaching and job placement support.',
    url: 'https://www.hackyourfuture.net',
    logoUrl:
      'https://www.google.com/s2/favicons?domain=hackyourfuture.net&sz=128',
    category: 'Developer education',
    status: GivebackCauseStatus.Active,
    sortOrder: 13,
    recommended: false,
