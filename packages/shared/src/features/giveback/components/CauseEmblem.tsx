...
// Brand-tinted emblems so each cause reads as its own tile, Lemonade-style.
const emblemAccents = [
...
// nonprofit. Falls back to a brand-tinted sparkle emblem if the logo is missing
// or fails to load (kept in state so we don't mutate the DOM node directly).
