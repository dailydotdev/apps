...
// Casino-style light sweep that rides across the filled portion of a funding
// meter, making the money raised feel alive. Clipped to `percentage` so the
// shine only travels over what's already been pledged.
