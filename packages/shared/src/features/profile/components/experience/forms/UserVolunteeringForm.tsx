    ...
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-2">
        <ControlledTextField
          name="title"
          label="Role*"
          placeholder="Ex: Volunteer Coordinator, Mentor, Event Organizer"
        />
        <ProfileCompany
        ...
        <ControlledTextField
          name="subtitle"
          label="Cause"
          placeholder="Ex: Education, Environment, Social Services, Animal Welfare"
        />
      </div>
      <HorizontalSeparator />
      <ControlledSwitch
        ...
        description="Check if you are actively volunteering with this organization"
      />
      <div className="flex flex-col gap-2">
        <div className="flex flex-col gap-2">
