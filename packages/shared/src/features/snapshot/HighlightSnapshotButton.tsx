...
/**
 * A highlight outlives its own link: the page it points at has usually moved
 * on by the time anyone opens it, so the claim has to travel as an image. The
 * card is staged off-screen at full size because the capture reads live DOM —
 * it has to be mounted before the press, not after.
 */
