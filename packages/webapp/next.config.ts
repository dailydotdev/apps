...
const nextConfig: NextConfig = {
  ...
  ...withBundleAnalyzer({
    ...
    env: {
      ...
      NEXT_PUBLIC_DAILY_CHROME_EXTENSION_ID:
        process.env.NEXT_PUBLIC_DAILY_CHROME_EXTENSION_ID ||
        process.env.EXTENSION_ID_CHROME ||
        '',
      NEXT_PUBLIC_DAILY_EDGE_EXTENSION_ID:
        process.env.NEXT_PUBLIC_DAILY_EDGE_EXTENSION_ID ||
