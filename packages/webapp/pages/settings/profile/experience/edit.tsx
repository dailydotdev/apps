...
import UserOpenSourceForm from '@dailydotdev/shared/src/features/profile/components/experience/forms/UserOpenSourceForm';
import UserProjectPublicationForm from '@dailydotdev/shared/src/features/profile/components/experience/forms/UserProjectPublicationForm';
import UserVolunteeringForm from '@dailydotdev/shared/src/features/profile/components/experience/forms/UserVolunteeringForm';
import {
  Button,
  ButtonSize,
  ButtonVariant,
...
const renderExperienceForm = (type?: UserExperienceType, location?: TLocation) => {
  switch (type) {
    ...
    case UserExperienceType.OpenSource:
      return <UserOpenSourceForm />;
    case UserExperienceType.ProjectPublication:
      return <UserProjectPublicationForm />;
    case UserExperienceType.Volunteering:
      return <UserVolunteeringForm location={location} />;
    case UserExperienceType.Project:
    case UserExperienceType.Work:
    default:
      return <UserWorkExperienceForm location={location} />;
  }
};
  ...
  return (
    <FormProvider {...methods}>
      ...
      >
        ...
        >
          {renderExperienceForm(experience?.type, experience?.location)}
        </AccountPageContainer>
      </form>
    </FormProvider>
  );
