  ...
  return (
    <>
      <PageContainer className="pt-6 pb-20 laptop:pb-6 laptop:self-start laptop:border-theme-divider-tertiary laptop:border-r laptopL:self-center laptopL:border-l">
        ...
        >
          <button
            className="flex mb-4 w-full h-10 items-center px-4 bg-theme-bg-secondary text-theme-label-secondary border-none rounded-2xl cursor-pointer typo-callout focus-outline"
            onClick={openNewComment}
          >
            {user && (
              <LazyImage
