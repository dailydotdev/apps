...
const AiCodingHubMonitorPage = (): ReactElement => {
  ...
  return (
    <div className="min-h-screen bg-background-default text-text-primary">
      ...
      />
      <div className="mx-auto max-w-4xl border-x border-border-subtlest-tertiary bg-background-default">
        <header className="border-b border-border-subtlest-tertiary px-3 py-3">
          ...
          <Link href="/ai-coding-hub" passHref>
            <a className="mt-2 inline-flex rounded-8 border border-border-subtlest-tertiary px-2 py-1 text-[10px] font-semibold uppercase tracking-wide text-text-secondary hover:bg-surface-hover hover:text-text-primary">
              Back to feed
            </a>
          </Link>
        </header>
