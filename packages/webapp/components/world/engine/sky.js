...
/* The sky is customisable, not a recency readout (which quarters of the map are
   ...
   One of these paints the world at EVERY zoom — a realm does not get to swap it
   for its own weather, see applySky — so what a palette has to do is hold six
   very different islands in one frame at once.
