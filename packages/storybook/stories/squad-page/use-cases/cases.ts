...
export const viewerCases: UseCase[] = [
  ...
  },
  {
    ...
    sees: 'Edit page in the header and Boost last, like Follow (beside Share page under the stats on a phone), Manage at the top of the options menu, View as a visitor and the share card, the Analytics widget, Poll in the composer, Add product on Products.',
    viewer: Viewer.Admin,
  },
  {
    id: 'blocked',
