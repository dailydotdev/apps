...
export const viewerCases: UseCase[] = [
  ...
  },
  {
    ...
    sees: 'Everything a member has, plus Manage in the options menu (Rules, FAQ, Followers, Moderation), View as a visitor and the share card at the top of the right column, and Poll in the composer. No analytics or settings.',
  ...
  },
  {
    ...
    sees: 'Edit page as a pen icon in the header and Boost last, like Follow (beside Share page under the stats on a phone), Manage at the top of the options menu, View as a visitor and the share card, the Analytics widget, Poll in the composer, Add product on Products.',
    viewer: Viewer.Admin,
  },
  {
    id: 'blocked',
...
export const postingCases: UseCase[] = [
  ...
  },
  {
    ...
    title: 'The queue',
    who: 'Moderator',
    sees: 'Member posts waiting for approval, with Approve and Decline. A moderator’s Manage menu holds Rules, FAQ, Followers and Moderation.',
    viewer: Viewer.Moderator,
    page: 'moderation',
    height: 44,
  },
