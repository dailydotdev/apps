...
export const viewerCases: UseCase[] = [
  ...
  },
  {
    ...
    sees: 'Everything a member has, plus Manage in the options menu with only Moderation, View as a visitor and the share card at the top of the right column, and Poll in the composer. No analytics or settings.',
