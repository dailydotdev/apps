...
const Profile = () => (
  ...
  >
    ...
    <Category
      ...
      title="The widgets"
      verdict="All three carry a snapshot button, icon-only, in the header row beside the H2 — the only place with room. Reading Overview has two summary cards, a tag-progress grid and the heatmap; Badges has two cards and a badge list; Achievements pairs its count link with the snapshot."
    >
      <Variant
