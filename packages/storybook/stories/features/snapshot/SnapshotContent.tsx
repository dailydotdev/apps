...
import colors from '@dailydotdev/shared/src/styles/colors';
...
/**
 * Generic card copy for the surfaces that have no designed card yet, so the
 * gallery can still show them on the real frame.
 */
