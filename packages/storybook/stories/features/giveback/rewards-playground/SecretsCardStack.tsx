...
// PLAYGROUND ONLY. A single scratch-off card holding ONE secret — the secret
// unlocked at this level. Scratch the foil away with the cursor (or hit
// "Reveal" if you don't drag). The next level reveals the next secret.
...
export const SecretsScratch = ({ fact }: { fact: string }): ReactElement => {
