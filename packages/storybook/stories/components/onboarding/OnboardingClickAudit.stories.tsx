...
const STEPS: AuditStep[] = [
  ...
  },
  {
    ...
    shownTo: 'Email signups, and OAuth signups missing a username',
    verdict: 'keep',
    today: ['Check the prefilled fields', 'Tap Sign up'],
    why: 'A form with several fields needs an explicit submit. The bigger win already landed: with the role step in front of it, a Google or GitHub signup skips this screen entirely.',
  },
  {
    id: 'pick-tags',
    name: 'Pick tags',
