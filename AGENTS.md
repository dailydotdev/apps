...
- **Confirm architecture pivots before switching layers** - If a fix could move between frontend and backend ownership, explicitly align on that direction before refactoring to a different layer.
